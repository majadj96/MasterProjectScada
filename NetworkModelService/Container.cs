...
namespace NetworkModelService
{
    ...
    //                break;
    //            case DMSType.PERLENGTHPHASEIMPEDANSE:
    //                io = new PerLengthPhaseImpedanse(globalId);
    //                break;
    //            case DMSType.PERLENGTHSEQUENCEIMPEDANSE:
    //                io = new PerLengthSequenceImpedanse(globalId);
    //                break;
    //            case DMSType.PHASEIMPEDANSEDATA:
    //                io = new PhaseImpedanseData(globalId);
    //                break;
    //            default:
