...
namespace DNP3.FunctionParameters
{
    public class WriteDiscreteOutFunction : DNP3Functions
    {
        ...
        public override byte[] PackRequest()
        {
            ...
            Buffer.BlockCopy(BitConverter.GetBytes((short)CommandParameters.TypeField), 0, dnp3Request, 13, 2);
            ...
            Buffer.BlockCopy(BitConverter.GetBytes(Convert.ToInt16(CommandParameters.ObjectValue)), 0, dnp3Request, 20, 2);
            ...
            Buffer.BlockCopy(BitConverter.GetBytes(crc1), 0, dnp3Request, 22, 2);
